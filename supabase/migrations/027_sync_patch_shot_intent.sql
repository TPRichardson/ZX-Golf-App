-- ============================================================
-- ZX Golf App — Sync Function Patch for ShotShape + ShotEffort
-- Migration: 027_sync_patch_shot_intent.sql
-- Adds Instance.ShotShape and Instance.ShotEffort to sync_upload and sync_download.
-- Full function replacement (only Instance sections changed from 024).
-- ============================================================
