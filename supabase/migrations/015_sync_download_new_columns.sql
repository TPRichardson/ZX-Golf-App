-- ============================================================
-- ZX Golf App — Sync Download RPC Update
-- Migration: 015_sync_download_new_columns.sql
-- Adds missing Drill columns (Description, Target, TargetDistanceUnit,
-- TargetSizeUnit) and UserDrillAdoption.HasUnseenUpdate to download payload.
-- ============================================================
...
BEGIN
  ...
  FROM (
    SELECT "DrillID", "UserID", "Name", "SkillArea", "DrillType", "ScoringMode",
           ...
           "RequiredSetCount", "RequiredAttemptsPerSet", "Anchors", "Target",
