...
class AnalysisFilters extends ConsumerWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Row 2: Conditional pickers (SkillArea / Drill).
          ...
          const SizedBox(height: SpacingTokens.sm),
          // Row 3: Resolution + DateRange + ChartMode.
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Row(
              children: [
                _buildResolutionChips(),
                const SizedBox(width: SpacingTokens.sm),
                _buildDateRangeChips(),
                const SizedBox(width: SpacingTokens.sm),
                _buildChartModeChips(),
              ],
            ),
          ),
        ],
  ...
  Widget _buildResolutionChips() {
    return _ChipGroup<TimeResolution>(
  ...
  Widget _buildDateRangeChips() {
    return _ChipGroup<DateRangePreset>(
  ...
  Widget _buildChartModeChips() {
    return _ChipGroup<ChartMode>(
