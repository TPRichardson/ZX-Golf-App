// Phase 4 — Raw Data Entry execution screen.
// S14 §14.3 — General numeric input with real-time scoring display.
...
class RawDataEntryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RawDataEntryScreen> createState() =>
      _RawDataEntryScreenState();
}

class _RawDataEntryScreenState extends ConsumerState<RawDataEntryScreen> {
  ...
  Future<void> _submitValue() async {
    ...
    setState(() {
      _lastScore = result.realtimeScore;
      if (result.realtimeScore != null) {
        _recentScores.add(result.realtimeScore!);
      }
    });
                  ...
                  children: [
                    ...
                    if (_lastScore != null) ...[
                      ...
                      if (_recentScores.length > 1) ...[
                        ...
                        Text(
                          'Avg: ${(_recentScores.reduce((a, b) => a + b) / _recentScores.length).toStringAsFixed(1)}',
                          style: TextStyle(
                            fontSize: TypographyTokens.bodySize,
